...
\begin{itemize}
    ...
    \newline\newline
    Además este cronograma se ha ido actualizando a medida que se iban completando las tareas, permitiendo una visualización clara del progreso del proyecto, como se muestra en la figura~\ref{roadmap_github}, y una escenificación de las tareas realizadas en el tiempo.\newline Enlace al roadmap del proyecto \cite{roadmap}.
