...
Durante la fase de despliegue del proyecto, se ha considerado el uso de una máquina dedicada que actuará como servidor para alojar tanto el backend como el frontend de forma permanente.
