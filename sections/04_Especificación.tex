...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Vicerrectorado de Transformación Digital:} Presentación del proyecto al Vicerrectorado de Transformación Digital de la UGR, en concreto con un mensaje a Cármen López Martínez, Subdirectora Técnica de Desarrollo, con descripción del sistema y posibles necesidades. Se concluye que el proyecto es interesante y sería usado, pero no es prioritario para la UGR, y no se puede proporcionar acceso a los recursos necesarios para el desarrollo del sistema. \newline
    \end{itemize}
\end{itemize}
