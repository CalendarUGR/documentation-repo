...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Correos electrónicos:} Durante la primera etapa del proyecto se han mandado varios correos al CSIRC y al CEPRUD de la UGR para solicitar información sobre el acceso a los recursos necesarios para el desarrollo del sistema.
    \begin{itemize}
        \item \textbf{CEPRUD:} Primera toma de contacto con Alberto Guillén Perales, Director del CEPRUD, para presentar el proyecto con una breve descripción del mismo, y presentar las posibles necesidades que se tendrían en el futuro. Mediante estos mensajes se consigue una entrevista con Alberto para profundizar en el acceso a los recursos necesarios para el desarrollo del sistema.
        \item \textbf{CSIRC:} Presentación del proyecto al CSIRC de la UGR, en concreto a Miguel Sánchez Román, Jefe de Servicio de Gestión Académica, con descripción del sistema y posibles necesidades. Mediante estos mensajes se concluye que el CSIRC no puede proporcionar acceso a los recursos necesarios para el desarrollo del sistema, ya que estos son privados y no están disponibles públicamente.
        \item \textbf{Vicerrectorado de Transformación Digital:} Presentación del proyecto al Vicerrectorado de Transformación Digital de la UGR, en concreto con un mensaje a Carmen López Martínez, Subdirectora Técnica de Desarrollo, con descripción del sistema y posibles necesidades. Se concluye que el proyecto es interesante y sería usado, pero no es prioritario para la UGR, y no se puede proporcionar acceso a los recursos necesarios para el desarrollo del sistema. \newline
    \end{itemize}
\end{itemize}
